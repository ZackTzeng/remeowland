...
library Shelter {
  ...
  function setTotal(bytes32 id, uint32 total) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((total)));
  }
  ...
  function setTotal(IStore _store, bytes32 id, uint32 total) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((total)));
  }
  ...
  function set(bytes32 id, string memory uri, uint32 total) internal {
    bytes memory _data = encode(uri, total);
  ...
  function set(IStore _store, bytes32 id, string memory uri, uint32 total) internal {
    bytes memory _data = encode(uri, total);
  ...
  function encode(string memory uri, uint32 total) internal view returns (bytes memory) {
