...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LastAffinity")));
bytes32 constant LastAffinityTableId = _tableId;

library LastAffinity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LastAffinity", _fieldNames);
  }
