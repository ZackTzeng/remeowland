...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AffinityMin")));
bytes32 constant AffinityMinTableId = _tableId;
...
library AffinityMin {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AffinityMin", _fieldNames);
  }
