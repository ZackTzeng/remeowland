...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AffinityMax")));
bytes32 constant AffinityMaxTableId = _tableId;
...
library AffinityMax {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AffinityMax", _fieldNames);
  }
